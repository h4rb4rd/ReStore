...
import { onAddedToCartAC, bookRemoveFromCartAC, allBooksRemoveFromCartAC } from '../../actions';
...
const mapDispatchToProps = (dispatch) => {
  return {
    onIncrease: (id) => {
      dispatch(onAddedToCartAC(id));
    },
    onDecrease: (id) => {
      dispatch(bookRemoveFromCartAC(id));
    },
    onDelete: (id) => {
      dispatch(allBooksRemoveFromCartAC(id));
    },
  };
};
